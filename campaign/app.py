...
def login():
    ...
    now = datetime.now()
    adjusted_time = now - timedelta(hours=16)  # Subtract 8 hours to get correct time
...
def get_last_modified_timestamp():
    ...
    try:
        ...
        if os.path.exists(csv_path):
            ...
            adjusted_time = timestamp_dt - timedelta(hours=16)  # Subtract 8 hours to get correct time
